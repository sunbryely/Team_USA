<%-- Filename: index.jsp
Description: This jsp page is for the page you see when you first come
to the website. The page has login fields and options for account
...
<div class="container well col-md-offset-1 col-md-10 col-lg-offset-1 col-lg-10" style = "opacity: 0.9; margin-top:75px;">
